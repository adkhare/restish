...
public class SchemaManipulation {
    ...
    private static final String DYN_KEYSPACE = "RESTish";
    private static final String DYN_CF = "Rest";
    
    private static StringSerializer stringSerializer = StringSerializer.get();
    
    public static void main(String[] args) throws Exception {
        
        Cluster cluster = HFactory.getOrCreateCluster("Vunez", "168.144.82.85:9160");
